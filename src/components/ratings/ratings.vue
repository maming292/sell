  ...
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <div class="rating-wrapper">
        <ul>
          <li v-show="needshow(rating.rateType,rating.text)" v-for="(rating, id) in ratings" :key="id" class="rating-item">
            <div class="avatar">
            ...
            <div class="content">
              ...
              <div class="recommend" v-show="rating.recommend.length">
                ...
                <span v-for="(item,id) in rating.recommend" :key="id" class="item">{{item}}</span>
              </div>
